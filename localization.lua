...
Results will print here when done.]],
  ...
  ["Account AuxStanding to %s."] = "Account GP to %s.", -- Internal use only (not GUI)
...
完成后打印结果.]],
  ...
  ["Account AuxStanding to %s."] = "记账 GP 到 %s.", -- Internal use only (not GUI)
  ...
  -- Removed GUI option: ["+AuxStanding to Raid"] = "+GP 给团队",
  ["Award MainStanding to all raid members."] = "奖励 EP 给所有团队成员.",
  -- Removed GUI option: ["Award AuxStanding to all raid members."] = "奖励 GP 给所有团队成员.",
  -- Removed GUI option: ["+AuxStanding to Member"] = "+GP 给成员",
  -- Removed GUI option: ["Account AuxStanding for member."] = "记账 GP 给成员.",
  ["Set Main"] = "设置大号",
  ["Set your Main Character."] = "设置你的大号角色.",
