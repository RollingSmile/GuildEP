...
Results will print here when done.]],
  ...
  ["You have gained %d AuxStanding."] = "You have gained %d GP.",
  ["%s%% decay to Standing."] = true,
  ["%d MainStanding awarded to Raid."] = "%d EP awarded to Raid.",
  ["%d MainStanding awarded to Reserves."] = "%d EP awarded to Reserves.",
  ...
  ["Giving %d AuxStanding to all raidmembers"] = "Giving %d GP to all raidmembers",
  ["You aren't in a raid dummy"] = true,
  ["Giving %d MainStanding to active reserves"] = "Giving %d EP to active reserves",
  ["Giving %d MainStanding to %s%s. (Previous: %d, New: %d)"] = "Giving %d EP to %s%s. (Previous: %d, New: %d)",
  ["Giving %d AuxStanding to active reserves"] = "Giving %d GP to active reserves",
  ["Giving %d AuxStanding to %s%s. (Previous: %d, New: %d)"] = "Giving %d GP to %s%s. (Previous: %d, New: %d)",
  ["%s MainStanding Penalty to %s%s. (Previous: %d, New: %d)"] = "%s EP Penalty to %s%s. (Previous: %d, New: %d)",
  ["%s AuxStanding Penalty to %s%s. (Previous: %d, New: %d)"] = "%s GP Penalty to %s%s. (Previous: %d, New: %d)",  
  ["%s\'s officernote is broken:%q"] = true,
  ["All Standing decayed by %d%%"] = true,
  ["All Standing decayed by %s%%"] = true,
  ["All AuxStanding has been reset to %d."] = "All GP has been reset to %d.",
  ["All Standing has been reset to 0/%d."] = true,
  ["You now have: %d MainStanding %d AuxStanding + (%d)"] = "You now have: %d EP %d GP + (%d)",
  ...
  ["Account AuxStanding to %s."] = "Account GP to %s.",
  ...
  ["+AuxStanding to Raid"] = "+GP to Raid",
  ["Award MainStanding to all raid members."] = "Award EP to all raid members.",
  ["Award AuxStanding to all raid members."] = "Award GP to all raid members.",
  ["+AuxStanding to Member"] = "+GP to Member",
  ["Account AuxStanding for member."] = "Account GP for member.",
  ["+MainStanding to Reserves"] = "+EP to Reserves",
  ["Award MainStanding to all active Reserves."] = "Award EP to all active Reserves.",
...
完成后打印结果.]],
  ...
  ["or $OS "] = "或 $OS ",
  ["$MS or "] = "$MS 或 ",
  ["You have received a %d MainStanding penalty."] = "你已经收到了 %d EP 处罚.",
  ["You have been awarded %d MainStanding."] = "你被授予 %d EP.",
  ["You have gained %d AuxStanding."] = "你得到了 %d GP.",
  ["%s%% decay to Standing."] = "%s%% 递减Standing.",
  ["%d MainStanding awarded to Raid."] = "%d EP 授予团队.",
  ["%d MainStanding awarded to Reserves."] = "%d EP 授予替补队员.",
  ...
  ["Giving %d MainStanding to all raidmembers"] = "给予 %d EP 到所有团员",
  ["Giving %d AuxStanding to all raidmembers"] = "给予 %d GP 到所有团员",
  ["You aren't in a raid dummy"] = "你不在一个团队",
  ["Giving %d MainStanding to active reserves"] = "给予 %d EP 在线的替补队员",
  ["Giving %d MainStanding to %s%s. (Previous: %d, New: %d)"] = "给予 %d EP 给 %s (以前: %d, 新: %d)",
  ["Giving %d AuxStanding to active reserves"] = "给予 %d GP 在线的替补队员",
  ["Giving %d AuxStanding to %s%s. (Previous: %d, New: %d)"] = "给予 %d GP 给 %s (以前: %d, 新: %d)", 
  ["%s MainStanding Penalty to %s%s. (Previous: %d, New: %d)"] = "%s EP 惩罚 %s. (以前: %d, 新: %d)",
  ["%s AuxStanding Penalty to %s%s. (Previous: %d, New: %d)"] = "%s GP 惩罚 %s. (以前: %d, 新: %d)",
  ["Awarding %d AuxStanding to %s%s. (Previous: %d, New: %d)"] = "奖励 %d GP 给 %s. (以前: %d, 新: %d)",
  ...
  ["All AuxStanding has been reset to %d."] = "所有GP已重置为 %d.",
  ["All Standing has been reset to 0/%d."] = "所有Standing已重置为 0/%d.",
  ["You now have: %d MainStanding %d AuxStanding + (%d)"] = "你现在有: %d EP %d GP + (%d) ",
  ...
  ["Account AuxStanding to %s."] = "记账 GP 到 %s.",
  ["retroll options"] = "retroll 设置",
  ["+MainStanding to Member"] = "+EP 给成员",
  ["Account MainStanding for member."] = "记账 EP 给成员.",
  ["+MainStanding to Raid"] = "+EP 给团队",
  ["+AuxStanding to Raid"] = "+GP 给团队",
  ["Award MainStanding to all raid members."] = "奖励 EP 给所有团队成员.",
  ["Award AuxStanding to all raid members."] = "奖励 GP 给所有团队成员.",
  ["+AuxStanding to Member"] = "+GP 给成员",
  ["Account AuxStanding for member."] = "记账 GP 给成员.",
  ["+MainStanding to Reserves"] = "+EP给替补队员",
  ["Award MainStanding to all active Reserves."] = "奖励 EP 给所有在线的替补队员.",
  ...
  ["Offspec Price %"] = "副天赋价值 %",
  ["Set Offspec Items AuxStanding Percent."] = "设置副天赋物品 GP 百分比.",
  ["Reset Standing"] = "重置 Standing",
  ["Reset AuxStanding"] = "重置 GP",
  ["Resets everyone\'s Standing to 0/%d (Admin only)."] = "重置所有人的 Standing 到 0/%d (只能管理员).",
  ["Resets everyone\'s AuxStanding to 0/%d (Admin only)."] = "重置所有人的 GP 到 0/%d (只能管理员).",
  ...
  ["|cffff0000Are you sure you want to Reset ALL AuxStanding?|r"] = "|cffff0000您确定要重置全部 GP?|r",
  ["Add MainSpec AuxStanding"] = "添加主天赋 GP",
  ["Add OffSpec AuxStanding"] = "添加副天赋 GP",
  ["Bank or D/E"] = "公会银行或分解师",
  ["%s looted %s. What do you want to do?"] = "%s 拾取了 %s. 你想做什么？",
  ["AuxStanding Actions"] = "GP 操作",
  ...
  ["Alts MainStanding %"] = "小号 EP %",
  ["Set the % MainStanding Alts can earn."] = "设置 % EP 小号可以赚取.",
  [", alts"] = ", 小号",
  ["New Alts"] = "新小号",
  [", alts MainStanding %"] = ", 小号 EP %",
  ["New Alts MainStanding %"] = "新小号 EP %",
  ...
  ["Minimum MainStanding: %s"] = "最小值 EP: %s",
