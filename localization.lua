...
L:RegisterTranslations("zhCN", function() return {
  ...
  -- logs
  ["guildroll logs"] = "guildroll 日志",
  ["Clear Logs."] = "清除日志.",
  ["Time"] = "时间",
  ["Action"] = "行为",
  -- loot
  ["guildroll loot info"] = "guildroll 拾取信息",
  ["Clear Loot."] = "清除拾取.",
  ["Item"] = "物品",
  ["Binds"] = "竞拍",
  ["Looter"] = "拾取人",
  ...
  ["Imported %d members.\n"] = "导入 %d 成员.\n",  
  ["%s\nFailed to import:"] = "%s\n未能导入:",
  ["guildroll standings"] = "guildroll 名单列表",
  ["Group by class"] = "职业分组",
...
完成后打印结果.]],
  ...
  ["PHYS DPS"] = "PHYS DPS",
  -- guildroll
  ["{guildroll}Type \"+\" if on main, or \"+<YourMainName>\" (without quotes) if on alt within %dsec."] = "{guildroll}使用 \"+\" 如果你在大号上, 或者 \"+<YourMainName>\" (没有引号) 如果在小号 %d秒.",
  ...
  ["Restart"] = "重新开始",  
  ["Restart guildroll if having startup problems."] = "重新开始 guildroll，如果有启动问题.",
  ["Standings"] = "排名",  
  ["Show Standings Table."] = "显示排名表.",
  ["v%s Loaded."] = "v%s 加载.",  
